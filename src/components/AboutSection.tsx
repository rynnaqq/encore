    ...
    <section id="about" ref={containerRef} className="py-16 sm:py-20 relative overflow-hidden">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div
          ...
          className={`border rounded-2xl p-4 sm:p-8 lg:p-10 relative overflow-hidden bg-white dark:bg-slate-900 border-[#FFCCE1] dark:border-slate-800 text-slate-800 dark:text-slate-100 shadow-xl shadow-pink-200/40 dark:shadow-none gpu-smooth transform-gpu`}
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
            ...
            <motion.div
              ...
              className={`lg:col-span-5 border rounded-xl p-4 sm:p-5 relative bg-[#FFF5D7] dark:bg-slate-800 border-[#FFCCE1] dark:border-slate-800 shadow-sm transform-gpu`}
            >
              <div className="flex items-center gap-3 mb-4 sm:mb-5 pb-3 border-b border-[#FFCCE1] dark:border-slate-800">
                <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-[#E195AB] text-white flex items-center justify-center font-bold shrink-0 shadow-md shadow-pink-300/40 dark:shadow-none">
                  <Terminal className="w-4 h-4" />
                </div>
                <div>
                  <h3 className="font-sans font-extrabold text-sm sm:text-base">Encore's Stack</h3>
              ...
              <div className="space-y-2 sm:space-y-2.5 font-sans">
                <motion.div 
                  ...
                  onClick={onOpenModal}
                  className={`p-2.5 sm:p-3 border rounded-xl flex flex-wrap items-center justify-between gap-1.5 transition-colors cursor-pointer bg-white dark:bg-slate-900 border-[#FFCCE1] dark:border-slate-800 hover:border-[#E195AB] hover:bg-[#FFF5D7] dark:hover:bg-slate-800 shadow-sm`}
                >
                  <div className="flex items-center gap-2">
                    <Code className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#E195AB]" />
                    <span className="text-xs font-semibold">Markup & Styling</span>
                  </div>
                  <span className="text-[10px] font-mono font-medium text-[#E195AB] bg-[#FFCCE1]/30 px-2 py-0.5 rounded border border-[#FFCCE1] dark:border-slate-800">
                    HTML5 / CSS3 / Tailwind
                  </span>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-2">
                    <Cpu className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#E195AB]" />
                ...
                >
                  <div className="flex items-center gap-2">
                    <User className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#E195AB]" />
              ...
              <motion.div variants={containerVariants} className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-2">
                {highlights.map((item, idx) => (
                  <motion.div
                    ...
                    onClick={onOpenModal}
                    className={`p-2.5 rounded-xl border flex items-start gap-2 font-sans text-xs font-medium cursor-pointer transition-colors bg-[#FFF5D7] dark:bg-slate-800 border-[#FFCCE1] dark:border-slate-800 text-slate-800 dark:text-slate-100 hover:border-[#E195AB] shadow-sm`}
                  >
