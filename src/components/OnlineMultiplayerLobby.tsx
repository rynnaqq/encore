          ...
          {showProfileModal && (
            <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md">
              ...
              >
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-xs font-bold text-slate-700 mb-1">Display Name (Terkunci)</label>
                    <input type="text" value={customName} disabled readOnly className="w-full px-3 py-2 rounded-xl bg-slate-100 border border-slate-200 text-sm font-bold text-slate-500 cursor-not-allowed" />
